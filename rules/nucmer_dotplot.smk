...
rule nucmer_species_to_species:
    input: 
        q="{species_q}/working/{sample_q}.{assembler}.{date}/{scaff_dir_q}.{purge_dir_q}.hic.{hic_sample_q}/out.break.salsa2/scaffolds_FINAL.fasta",
        r="{species_r}/working/{sample_r}.{assembler}.{date}/{scaff_dir_r}.{purge_dir_r}.hic.{hic_sample_r}/out.break.salsa2/scaffolds_FINAL.fasta"
    output: "{species_r}/working/dot/{sample_r}.{assembler}.{date}.{scaff_dir_r}.{purge_dir_r}.hic.{hic_sample_r}/"
            "vs.{species_q}.{sample_q}.{scaff_dir_q}.{purge_dir_q}.hic.{hic_sample_q}.delta"
    params: 
        prefix="{species_r}/working/dot/{sample_r}.{assembler}.{date}.{scaff_dir_r}.{purge_dir_r}.hic.{hic_sample_r}/"
               "vs.{species_q}.{sample_q}.{scaff_dir_q}.{purge_dir_q}.hic.{hic_sample_q}",
        queue="long"
    # log: "{species}/working/dot/{sample_r}.{assembler}.{date}.{scaff_dir_r}.{purge_dir_r}.hic.{hic_sample_r}/"
    #         "vs.{sample_q}.{scaff_dir_q}.{purge_dir_q}.hic.{hic_sample_q}.log"
    conda: "nucmer_dotplot.yml"
